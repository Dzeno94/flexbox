function getValues() {
    ...
    var item1Style = document.getElementById("div1-style").value;
    item1.style = `align-self:${item1Style}`;
    var item2 = document.getElementById("div2");
    var item2Style = document.getElementById("div2-style").value;
    item2.style = `align-self:${item2Style}`;
    var item3 = document.getElementById("div3");
    var item3Style = document.getElementById("div3-style").value;
